...
*/
  uint8_t inputArray[] = "0.054000001,6,0.0024,-0.0006,3.856600046,-0.061000001,-0.061000001,0,34.83589935";
  ...
  while (1)
  {
	 ...
	 */
	  ...
	  */
	  ...
	  HAL_UART_Transmit(&huart2, compressed, sizeof(compressed), 1000);
	  HAL_Delay(2000);
